  ...
  return (
    <footer className="bg-white text-gray-800 py-16 px-4 border-t border-gray-100">
      <div className="container mx-auto">
        <div className="lg:flex lg:justify-between lg:items-start grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {/* Column 1 - Company Info */}
          <div className="lg:w-auto">
            <Logo variant="blue" className="mb-6 h-8" />
            <p className="text-gray-500 text-sm mb-6 leading-relaxed max-w-xs">
            A free email service that allows you to get temporary emails.
            </p>
          ...
          <div className="lg:flex lg:gap-36 grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Column 2 - For Developers */}
            <div>
              <h3 className="font-bold mb-5 text-gray-800">For Developers</h3>
            ...
            <div>
              <h3 className="font-bold mb-5 text-gray-800">Product</h3>
              <ul className="space-y-3 text-sm text-gray-500">
            ...
            {/* Column 4 - Company */}
            <div>
              <h3 className="font-bold mb-5 text-gray-800">Company</h3>
              <ul className="space-y-3 text-sm text-gray-500">
